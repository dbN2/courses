...
Fraction::Fraction(int a, int b){        // generate a fraction which is a/b
...
Fraction::Fraction(int a){       // generate a fraction which is a/1

	num = a;
	den = 1;
}
    
Fraction::Fraction(){      // generate a fraction which is 0/1. i.e 0
	num = 0;
	den = 1;
}
...
bool operator <= (const Fraction& f1, const Fraction& f2){
 ...
 bool operator >= (const Fraction& f1, const Fraction& f2){
  ...
  bool operator == (const Fraction& f1, const Fraction& f2){
  	Fraction f = f1 -f2;
	return f.num== 0; // fraction is 0 if and only if numerator is 0
  }
    // return true if f1 is equal to f2.
    // False otherwise
